    ...
    <div className="flex flex-col gap-5 mt-6 px-6">
      <div className="flex  gap-16 w-full justify-start md:justify-end pr-10">
        <div className="flex items-center gap-4">
            <img className="w-[40px] sm:w-[50px]" src={Student.image} alt="" />
          <span className="flex flex-col ">
              <h2 className="text-[15px] font-semibold">{Student.firstName}</h2>
              <p className="text-[13px] font-medium">{Student.class}</p>
